...
public partial class AcknowledgeTransport<T>
{
	private partial class Log
	{
		...
		[LoggerMessage(LoggingEventIds.AcknowledgeTransportTransportedAck, LogLevel.Debug,
			"Transported acknowledge for request {RelayRequestId} on connection {TransportConnectionId}")]
		public static partial void TransportedAck(ILogger logger, Guid relayRequestId, string? transportConnectionId);
